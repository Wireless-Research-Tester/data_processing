...
def graph_all_freqs(total_freqs=10, start_freq=1000, freq_inc=100, angle=1):
...
def graph_one_freq(req_freq=1000, start_freq=1000, freq_inc=100, angle=1):
    # read the csv into pandas dataframe
    df = pd.read_csv("sample_output.csv")
